...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 27, 2018 at 10:22 AM
...
DROP TABLE IF EXISTS `tb_measures`;
...
--
ALTER TABLE `tb_custs`
  MODIFY `cust_indx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=118;
...
--
ALTER TABLE `tb_item_cate`
  MODIFY `item_cate_indx` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
